...
class ScriptManagerTests(unittest.TestCase):
    def test_snapshot_exposes_script_library_items(self) -> None:
        ...
        self.assertFalse(scripts[6]["requiresMousePrecision"])
